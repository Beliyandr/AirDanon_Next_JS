...
export function Testing() {
  return (
    <section className="section testing-section" id="testing"><div className="container">
      <SectionHead eyebrow="Контроль качества" title="Путь каждой антенны" text="Четыре последовательных этапа превращают расчет в предсказуемый рабочий инструмент." />
