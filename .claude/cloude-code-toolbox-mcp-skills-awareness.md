...
_Generated: 2026-06-30T08:50:08.067Z_
...
Workspace `mcp.json` _(folder: next)_

- **c:\Users\Andrew\Documents\Codex\2026-05-19\next\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Andrew\.claude.json** — _File missing_
